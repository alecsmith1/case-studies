...
- **Cleaning** - conducted in Excel <a href="https://alecsmith1.github.io/case-studies/2025/02/05/cyclistic-case-study.html#data-processing---conducted-in-excel" target="_blank" rel="noopener noreferrer">(detailed list of cleaning steps & formulas used)</a>
- **Augmentation** - conducted in Excel <a href="https://alecsmith1.github.io/case-studies/2025/02/05/cyclistic-case-study.html#data-augmentation---steps-taken" target="_blank" rel="noopener noreferrer">(detailed list of augmentation steps & formulas used)</a>
- **Analysis** - conducted via SQL in BigQuery <a href="https://alecsmith1.github.io/case-studies/2025/02/05/cyclistic-case-study.html#data-analysis---conducted-in-bigquery-with-sql" target="_blank" rel="noopener noreferrer">(detailed list of SQL queries & results)</a>
...
- **Data Source –** Data used in this analysis is internal to the company and can be found <a href="https://divvy-tripdata.s3.amazonaws.com/index.html" target="_blank" rel="noopener noreferrer">here</a>.
- **Data License –** Data made available for public use via the <a href="https://divvybikes.com/data-license-agreement" target="_blank" rel="noopener noreferrer">data license agreement</a>.
